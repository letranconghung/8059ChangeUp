...
void blueRight9(){
  ...
  //Goal1 - Goal C
  setMech(0,0,123,0); //80 - 122
  baseMove(-3.1,0.5,0); //-3.1， 0.5， 0
  waitBase(400);
  delay(10);
  setMech(0,0,-127,0,570); //eject ball 580

  //Goal 2 - Goal B
  baseMove(5.8); //5.2
  waitBase(600);
  baseTurn(76.9);//face goal 76.5
  waitBase(1200);//900
  baseMove(47);//45
  waitBase(1200);
  setMech(-127,-127,-127,0,400); //eject ball
  ...
  baseMove(-4); //5
  waitBase(300);
  baseTurn(-75.5); //face goal //75.5
  waitBase(1200);
  setMech(0,0,30,0);
  baseMove(54.5);//52.5
  waitBase(1500);
  setMech(-127,-127,127,127,600); //shoot -500

  //Goal4 - Goal I
  setMech(0,0,0,0);
  baseMove(-15); //13
  waitBase(600);
  baseTurn(-37.5); //face goal -37
  waitBase(600);
  setMech(127,127,0,0);
  baseMove(77.5,0.5,0); //intake ball
  waitBase(1550);
  baseTurn(-65);
  waitBase(400);
  setMech(0,0,0,0);
  ...
  baseMove(27,0.45,0);
  waitBase(800);
  timerBase(127,50,650); //face ball -500
  delay(5);
